...
\title{Path Integrals and the Quantum--Statistical Correspondence}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{path-integral-fig1-spacetime.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{path-integral-fig2-slits.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{path-integral-fig3-paths.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{path-integral-fig4-wick.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{path-integral-fig5-cylinder.png}
...
\begin{equation}
\begin{aligned}
    S[x(t)] = \int^{t_f}_{t_i} dt \,\left[\frac{1}{2}m\dot{x}^2 - V(x)\right]
    = i\int^{\tau_f = it_f}_{\tau_i=it_i}d\tau \,\left[\frac{1}{2}m\left(\frac{dx_E(\tau)}{d\tau}\right)^2 + V[x_E(\tau)]\right]
    \equiv i S_E[x_E(\tau)],
\end{aligned}
\end{equation}
...
\begin{equation}
    Z = \int dx \bra{x}e^{-\beta H}\ket{x}
      = \int dx \int_{x_E(\tau_i)=x}^{x_E(\tau_f)=x} \mathcal{D}x_E(\tau)e^{-S_E[x_E(\tau)]/\hbar},
    \label{1}
\end{equation}
...
\begin{equation}
    Z = \oint \mathcal{D}x_E(\tau) \, e^{-S_E[x_E(\tau)]/\hbar},
\end{equation}
