...
\begin{equation}
    ...
    = \frac{1}{(4\pi)^{d/2}}\,\Gamma\!\Big(2 - \tfrac{d}{2}\Big)\Big(\frac{\Delta}{\mu^2}\Big)^{d/2-2}
    = \frac{1}{16\pi^2}\left(\frac{2}{\epsilon} - \gamma + \ln 4\pi - \ln\frac{\Delta}{\mu^2}\right) + \mathcal{O}(\epsilon),
\end{equation}
