...
def schwartz_catalogue() -> tuple[str, int]:
    ...
    body = """    <h3 class="catalogue-source">
      ...
      <a href="https://www.cambridge.org/highereducation/books/quantum-field-theory-and-the-standard-model/A4CD66B998F2C696DCC75B984A7D5799" target="_blank" rel="noopener noreferrer">Book website ↗</a>
    </h3>
    <ul class="catalogue">
{items}
    </ul>
    ...
    <ul class="catalogue">
      <li class="catalogue__item">
        ...
        <span class="catalogue__main">
          ...
          <span class="catalogue__desc">Transfer matrices, mean-field and tricritical transitions, XY order, and scaling. Worked problems: 1–8.</span>
        </span>
      ...
      <li class="catalogue__item">
        ...
        <span class="catalogue__main">
          ...
          <span class="catalogue__desc">Correlations, Lifshitz scaling, gauge coupling, anisotropy, and Wick's identity. Worked problems: 1, 2, 5, 6, 7, 8; Problems 3 and 4 remain pending.</span>
        </span>
