...
WHOLE_FILE_PAGES = [
    ...
    ("HOAQFTPS2.tex", "osborn-aqft-ps2",
        "Functional Methods &amp; Grassmann Integrals — Osborn AQFT PS2",
        "Quantum Field Theory · Osborn AQFT PS2",
        "H. Osborn, <em>Advanced Quantum Field Theory</em>, Problem Sheet 2 (functional methods, effective action, Grassmann integrals, SUSY QM)."),
    ("HOAQFTPS3.tex", "osborn-aqft-ps3",
        "Feynman Graphs &amp; RG Calculations — Osborn AQFT PS3",
        "Quantum Field Theory · Osborn AQFT PS3",
        "H. Osborn, <em>Advanced Quantum Field Theory</em>, Problem Sheet 3 (superficial divergence, Feynman parameters, position-space loop integrals, φ⁴ counter-terms, two-loop β functions, RG equations, φ³ in d=6)."),
