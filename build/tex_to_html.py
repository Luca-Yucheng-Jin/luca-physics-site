...
JOBS = [
    ...
    ("QM.tex", [
        ("non-degeneracy and reality of bound states", "qm-bound-states",
            "Quantum Mechanics · Cambridge Example Sheet 1 Q4",
            "Cambridge Quantum Mechanics, Example Sheet 1, Question 4; accompanies David Tong’s notes."),
        ("absence of odd-parity bound states",          "qm-shallow-well",
            "Quantum Mechanics · Cambridge Example Sheet 1 Q7",
            "Cambridge Quantum Mechanics, Example Sheet 1, Question 7; accompanies David Tong’s notes."),
        ("factorisation method for the sech",           "qm-sech-squared",
            "Quantum Mechanics · Cambridge Example Sheet 1 Q8",
            "Cambridge Quantum Mechanics, Example Sheet 1, Question 8; accompanies David Tong’s notes."),
    ]),
    # ---- ED.tex ----
    ("ED.tex", [
        ("retarded potentials and far-field",     "ed-retarded",
            "Electrodynamics · Electromagnetism Chapter 7 Q4",
            "Cambridge Electromagnetism, Chapter 7 exercises, Question 4; accompanies David Tong’s <em>Electromagnetism</em>."),
        ("liénard--wiechert potential",          "ed-lienard-wiechert",
            "Electrodynamics · Electromagnetism Chapter 7 Q6",
            "Cambridge Electromagnetism, Chapter 7 exercises, Question 6; accompanies David Tong’s <em>Electromagnetism</em>."),
        ...
        ("dielectric sphere in a uniform",       "ed-dielectric-sphere",
            "Electrodynamics · Electromagnetism Chapter 8 Q1",
            "Cambridge Electromagnetism, Chapter 8 exercises, Question 1; accompanies David Tong’s <em>Electromagnetism</em>."),
        ("frustrated total internal reflection", "ed-frustrated-tir",
            "Electrodynamics · Electromagnetism Chapter 8 Q3",
            "Cambridge Electromagnetism, Chapter 8 exercises, Question 3; accompanies David Tong’s <em>Electromagnetism</em>."),
    ]),
    # ---- MM.tex ----
    ("MM.tex", [
        ...
        ("convolution of $e",                    "mm-convolution-fourier",
            "Mathematical Methods · Santos Example Sheet 3 Q2",
            "J. E. Santos, Cambridge Part IB Complex Methods, Example Sheet 3, Question 2."),
        ("residues at simple poles",             "mm-residues",
            "Mathematical Methods · Santos Example Sheet 2 Q7",
            "J. E. Santos, Cambridge Part IB Complex Methods, Example Sheet 2, Question 7."),
        ("contour integration via residue",      "mm-contour-integration",
            "Mathematical Methods · Santos Example Sheet 2 Q9",
            "J. E. Santos, Cambridge Part IB Complex Methods, Example Sheet 2, Question 9."),
        ("laplace transform of",                 "mm-laplace-bromwich",
            "Mathematical Methods · Santos Example Sheet 3 Q12",
            "J. E. Santos, Cambridge Part IB Complex Methods, Example Sheet 3, Question 12."),
        ("variational derivation of euler",      "mm-variational-euler",
            "Mathematical Methods · Cambridge Variational Principles ES2 Q9",
            "Cambridge Mathematical Tripos, Variational Principles, Example Sheet 2 (2023), Question 9."),
    ]),
    # ---- DE.tex ----
    ("DE.tex", [
...
WHOLE_FILE_PAGES = [
    ...
    ("phi3.tex", "phi3-theory",
        "Computation for φ³ Theory",
        "Quantum Field Theory · φ³ perturbative computation",
        "Follows Srednicki and Peskin &amp; Schroeder — counter-terms, partition functional, and one-loop diagrams in φ³."),
    ("srednickinonabelian.tex", "srednicki-nonabelian",
        "Nonabelian Symmetries — Srednicki Ch. 24",
        "Quantum Field Theory · Srednicki Ch. 24",
        "M. Srednicki, <em>Quantum Field Theory</em>, Chapter 24 (Nonabelian Symmetries), Problems 24.1–24.4."),
    ("RGSrednicki.tex", "srednicki-rg-phi-chi",
        "Renormalization Group for φ-χ Theory — Srednicki Q28.3",
        "Quantum Field Theory · Srednicki Ch. 28",
        "M. Srednicki, <em>Quantum Field Theory</em>, Chapter 28 (Renormalization Group), Problem 28.3."),
    ...
    ("HOAQFTPS2.tex", "osborn-aqft-ps2",
        "Functional Methods &amp; Grassmann Integrals — Osborn AQFT Example Sheet 2",
        "Quantum Field Theory · Osborn AQFT Example Sheet 2",
        "H. Osborn, <em>Advanced Quantum Field Theory</em>, Example Sheet 2 (functional methods, effective action, Grassmann integrals, SUSY QM)."),
    ("HOAQFTPS3.tex", "osborn-aqft-ps3",
        "Feynman Graphs &amp; RG Calculations — Osborn AQFT Example Sheet 3",
        "Quantum Field Theory · Osborn AQFT Example Sheet 3",
        "H. Osborn, <em>Advanced Quantum Field Theory</em>, Example Sheet 3 (superficial divergence, Feynman parameters, position-space loop integrals, φ⁴ counter-terms, two-loop β functions, RG equations, φ³ in d=6)."),
    ("DTGRPS1.tex", "tong-gr-ps1",
        "Differential Geometry",
        "General Relativity · Tong GR PS1",
    ...
    ("DTGRPS2.tex", "tong-gr-ps2",
        ...
        "General Relativity · Tong GR PS2",
    ...
    ("DTGRPS3.tex", "tong-gr-ps3",
        ...
        "General Relativity · Tong GR PS3",
    ...
    ("DTGRPS4.tex", "tong-gr-ps4",
        ...
        "General Relativity · Tong GR PS4",
